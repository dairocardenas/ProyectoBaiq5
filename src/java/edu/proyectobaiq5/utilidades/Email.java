 ...
 */
package edu.proyectobaiq5.utilidades;
...
public class Email {
    public static void sendModificacion(String para, String Nombres, String nombUsu, String clave) {
        final String user = "ProyectoBaiq5@gmail.com";//cambiará en consecuencia al servidor utilizado
        final String pass = "AlphaC.2020*";
...
//2nd paso)compose message
    ...
    public static void sendClaves(String para, String PrimerNombre, String correoUsu, String Password) {
        final String user = "ProyectoBaiq5@gmail.com";//cambiará en consecuencia al servidor utilizado
        final String pass = "AlphaC.2020*";
...
//2nd paso)compose message
        try {
            ...
            message.setFrom(new InternetAddress(user));
            message.addRecipient(Message.RecipientType.TO, new InternetAddress(para));
            message.setSubject("Bienvenido al sistema BAIQ");

            message.setContent(
                    "<center><img src='https://vinti7.com/wp-content/uploads/2016/05/logos-de-bicicletas-36.jpg' title='Bienvenido al sistema Baiq '></center>"
    ...
    public static void sendBienvenido(String para, String PrimerNombre, String correoUsu, String Password) {
         final String user = "ProyectoBaiq5@gmail.com";//cambiará en consecuencia al servidor utilizado
        final String pass = "AlphaC.2020*";
